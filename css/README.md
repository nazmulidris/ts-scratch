...
- When a modal dialog is shown it takes up the entire viewport. So if you were to call
  ...
  [`elementFromPoint` docs](https://developer.mozilla.org/en-US/docs/Web/API/Document/elementFromPoint)
...
- [Tutorial](https://dev.to/beumsk/how-to-add-emoji-s-in-your-website-using-html-css-or-javascript-4g6g)
...
- CSS
  ...
  You must replace the `U+` with `\0` in the codepoint. So instead of `U+<code>` you use `\0<code>`
