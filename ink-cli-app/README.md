...
- [Build a CLI app using Ink and flexbox](#build-a-cli-app-using-ink-and-flexbox)
  - [Major changes from the scaffolding provided by `create-ink-app` v2.1.1](#major-changes-from-the-scaffolding-provided-by-create-ink-app-v211)
  ...
  - [Using devtools and testing](#using-devtools-and-testing)
...
### Major changes from the scaffolding provided by `create-ink-app` v2.1.1
...
This is going to be a pretty big divergence to the configuration and code that's generated by the
...
### Using devtools and testing

```yaml
🔥TODO:
  - Learn about ava and xo and decide whether to keep it or replace w/ jest and RTL
